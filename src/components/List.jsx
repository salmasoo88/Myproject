...
const ListTypes = ({ props }) => {
  ...
  const flagList = [
    ...
    { id: "IL", name: "Israel", flagImage: Israel },
    ...
    { id: "LB", name: "Lebanon", flagImage: Lebanon },
    { id: "NL", name: "Netherlands", flagImage: Netherlands },
    { id: "MK", name: "North Macedonia", flagImage: North_Macedonia },
    ...
    { id: "NA", name: "Namibia", flagImage: Namibia },
    { id: "SL", name: "Sierra Leone", flagImage: Sierraleone },
